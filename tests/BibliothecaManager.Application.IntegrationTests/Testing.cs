...
namespace BibliothecaManager.Application.IntegrationTests;
...
public class Testing
{
    ...
    public async Task RunBeforeAnyTestsAsync()
    {
        ...
        services.AddSingleton(Mock.Of<IWebHostEnvironment>(w =>
            ...
            w.ApplicationName == "BibliothecaManager.Api"));
    ...
    {
        var rand = new Random();
        return await RunAsUserAsync($"test.{rand.Next()}@local", "Testing1234!", Array.Empty<string>());
    }
