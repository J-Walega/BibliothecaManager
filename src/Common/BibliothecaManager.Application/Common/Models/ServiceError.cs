...
namespace BibliothecaManager.Application.Common.Models;
...
public class ServiceError
{
    ...
    /// </summary>
    public static ServiceError ForbiddenError => new("You are not authorized to call this action.", 401);
    ...
    public static ServiceError CustomMessageAndCode(string errorMessage, int errorCode)
    {
        return new ServiceError(errorMessage, errorCode);
    }

    public static ServiceError UserNotFound => new("Wrong email or password", 401);
    ...
    public static ServiceError NotFound => new("The specified resource was not found.", 404);
